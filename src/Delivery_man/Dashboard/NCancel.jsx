...
const NCancel = ({ isOpen, handleClose, details }) => {
      ...
      >
        <Card.Header style={{ position: 'relative', backgroundColor: randomBackgroundColor, color: '#000'}}>
         <div style={{display:"flex"}}>
          ...
          <Card.Text style={{ color: '#000', fontSize: "1rem",marginLeft:"120px" }}><span style={{fontStyle:"italic"}}>Order Status : </span> <span style={{ color: "red" }}><span style={{fontStyle:"italic"}}>{item?.order?.status === "cancel"?"Cancelled" :""}</span></span></Card.Text>
          </div>
        </Card.Header>
