  ...
  return (
    ...
    >
      ...
      <Card.Body style={{ display: 'flex', flexDirection: 'row', background: "#FFFAFA" }}>
        ...
        <div style={{ flex: 0.5 }}>
          <Card.Text style={{ color: '#000', fontSize: "1rem" }}><span style={{fontStyle:"italic"}}>Order Status : </span> <span style={{ color: "green" }}><span style={{fontStyle:"italic"}}>{ rso && rso.status === "delivered"?"Delivered" :""}</span></span></Card.Text>
          <button
        style={{
