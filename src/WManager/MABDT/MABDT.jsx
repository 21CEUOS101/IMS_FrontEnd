...
const CompletedOrders = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
          try {
              const orderData = await getallapprovedbutisDTByMid();
              setOrders(orderData);
              setLoading(false);
          } catch (error) {
