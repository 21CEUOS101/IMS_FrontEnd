...
import SABDFDetails from './SABDFDetails'  
  ...
  return (
    ...
    >
      ...
      <Card.Body style={{ display: 'flex', flexDirection: 'row', background: "#FFFAFA" }}>
        ...
        <div style={{ flex: 0.3 }}>
        Status: <span style={{fontStyle:"italic",color:"purple"}}> {supplyOrder?.status === "approved" ? "Approved" :"Approved"}</span>
          <Button
            style={{
      ...
      <SABDFDetails isOpen={isDialogOpen} handleClose={handleCloseDialog} details={selectedOrder} />
    </Card>
  );
}
