...
import SABDTDetails from './SABDTDetails'  
...
function HoverCardWithHeaderExample({ data }) {
  const { supplyOrder, user, product,warehouse,Manager_user,manager,delivery_man,D_user } = data;
  ...
  return (
    ...
    >
      ...
      <SABDTDetails isOpen={isDialogOpen} handleClose={handleCloseDialog} details={selectedOrder} />
    </Card>
  );
}
